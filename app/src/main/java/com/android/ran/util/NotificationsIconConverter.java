...
public class NotificationsIconConverter {

    public static Drawable convertLayoutToImage(Context mContext, int count, int drawableId) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.layout_notifications_icon, null);
        ...
        if (count == 0) {
            ...
            TextView textView = view.findViewById(R.id.notifications_count);
